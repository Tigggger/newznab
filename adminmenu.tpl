...
<ul class="navigator">
	...
	<li><a href="{$smarty.const.WWW_TOP}/group-list.php?active=1">View</a><span class="divider">/</span></li>
...
<ul class="navigator">
	...
	<li><a style="padding:0;" href="{$smarty.const.WWW_TOP}/nzb-export.php">Export</a></li>
</ul>
<ul class="navigator">
...
<ul class="navigator">
	...
	<li><a style="padding:0;" href="{$smarty.const.WWW_TOP}/user-edit.php?action=add">Add</a></li>
</ul>
<ul class="navigator">
	...
	<li><a style="padding:0;" href="{$smarty.const.WWW_TOP}/role-edit.php?action=add">Add</a></li>
</ul>
<ul class="navigator">
	...
	<li><a style="padding:0;" href="{$smarty.const.WWW_TOP}/site-debug.php">Debug</a></li>
</ul>
</li>
